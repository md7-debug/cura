...
- Dictionary lookups resolve redirects and degrade to the attributed full Wiktionary entry when no concise definition can be rendered; Retry never becomes the reader’s only path forward.
...
The library contains all 124 Seneca letters; six further complete Seneca works across fourteen readings; all twelve books of Marcus Aurelius’s *Meditations*; Epictetus’s opening *Enchiridion* passage; the twelve essays in Emerson’s *Society and Solitude* and *Self-Reliance*; and all eighteen chapters of Thoreau’s *Walden*. Letters 1–20 and 32 include a close Cura reading guide; the remaining Seneca letters use a clearly framed reading lens until a letter-specific guide is edited and reviewed. New works enter one verified bilingual edition at a time. English-only placeholders remain in the visible edition-review queue, never in the published reading corpus.
